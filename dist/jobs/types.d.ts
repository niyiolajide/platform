...
export declare const DEDUPE_CONFLICT_CODE = "DEDUPE_CONFLICT";
/** Store adapters throw this from `create` when the dedupeKey already exists. */
export declare class DedupeConflictError extends Error {
    readonly code = "DEDUPE_CONFLICT";
 ...
 */
export declare function isDedupeConflict(err: unknown): boolean;
/**
